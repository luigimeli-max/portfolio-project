...
Professional portfolio website settings with security and performance optimizations.
"""
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-change-this-in-production-use-strong-key-here')
...
# Database
# Usa PostgreSQL se DB_NAME è impostato, altrimenti SQLite per sviluppo
...
# Use CompressedManifestStaticFilesStorage only in production after collectstatic
if DEBUG:
